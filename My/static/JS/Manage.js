    ...
    Self.widthProportion = function () {
      var p =
        ((document.body && document.body.clientWidth) ||
          document.getElementsByTagName("html")[0].offsetWidth) / Self.width;
      return p;
    };
...
window.onclick = function (location) {
  ...
  if (
    Menu_State == false &&
    (Element_ID == "Title_Menu_Button" || Element_ID == "Title_Menu_Turn")
  ) {
...
var SomeThing_Load = (Name, ID) => {
  ...
  /* NewUser_Input(); */
  document.getElementById("Lock_Page").style.backgroundImage =
...
var Page_Lock = (State) => {
  ...
  if (State) {
    ...
    Load_Page.style.backgroundImage =
      "url('https://api.isoyu.com/bing_images.php')";
